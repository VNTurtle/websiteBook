...
$query_lstmodel = "SELECT b.*, m.Model, m.ModelBin, i.Path
FROM book b
...
$lst_model = DP::run_query($query_lstmodel, $parameters, $resultType)
?>
...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Sản Phẩm /</span> Model Sản Phẩm
        </h4>
        <!-- Model List Table -->
        <div class="card">
