            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    <a href="" class="logo-ft" title="logo">
                        <img src="assets/img/logo-bookstore.jpg" alt="Logo">
                    </a>
                    ...
                    <ul class="Pay">
                        <li><img style="width: 50px; height: 30px;" src="assets/img/payment_1.webp" alt=""></li>
                        <li><img style="width: 50px; height: 30px;" src="assets/img/payment_2.webp" alt=""></li>
                        <li><img style="width: 50px; height: 30px;" src="assets/img/payment_3.webp" alt=""></li>
                    </ul>
                </div>
                <div class="col-12 col-md-6 col-lg-3">
...
if (isset($page)) {
    $pageScript = "assets/js/{$pageName}.js";
